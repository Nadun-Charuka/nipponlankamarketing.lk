                ...
                <div className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
                    <div className="px-4 py-6 sm:p-8">
                        ...
                        <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-2">
                                <label htmlFor="installment_months" className="block text-sm font-medium leading-6 text-gray-900">
                                    Installment Plan
                                </label>
                                <div className="mt-2">
                                    <select
                                        ...
                                        onChange={(e) => setFormData(prev => ({ ...prev, installment_months: parseInt(e.target.value) }))}
                                        className="block w-full rounded-lg border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm leading-6"
                                    >
                                        <option value={0}>No Installments</option>
                                ...
                                {formData.base_price && (
                                    <p className="mt-1 text-xs text-gray-500">
                                        Downpayment: Rs. {Math.round(formData.base_price / 3).toLocaleString()} (1/3)
                                    </p>
                                )}
                            </div>
                            <div className="sm:col-span-2">
